...
export default function CourseBuilder() {
  // Page Header
  const pageTitle = "Course Builder";
  const pageDescription = "Create and Edit your Course";
      ...
      const defaultSectionsData = [
        {
          ...
          content: "<h1>Section Content Example</h1><p>This is a paragraph</p>",
          order: 1,
        },
      ];

      setSections(defaultSectionsData);
    };
  ...
  return (
    <div className="min-h-screen w-screen bg-gray-100">
      <div className="w-full">
        ...
        />
        <div className="max-w-7xl mx-auto pt-5 px-2">
          <div className="flex flex-row gap-2 mb-3">
            ...
            <button
              className="bg-transparent text-gray-900 hover:text-blue-600"
                  ...
                  return (
                    <div className="flex flex-col gap-2 text-gray-900 mb-5">
                      <div className="flex flex-wrap gap-4">
                        ...
                        <button
                          className="bg-transparent py-0 px-1 border-0"
                      ...
                      <ReactQuill
                        ...
                        onChange={(newContent) =>
                          handleChange(sectionId, section.title, newContent)
                        }
